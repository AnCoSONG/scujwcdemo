    ...
    <el-row>
      ...
      >
        <div class="card">
          ...
          <!-- <div class="line"></div> -->
          <el-tooltip class="item" effect="dark" content="点击进入学生端" placement="top">
            <a class="type" @click="onClickType('teacher')">教师端</a>
          </el-tooltip>
          <div class="form">
            <el-form
              ref="loginform"
...
export default {
  ...
  data() {
    ...
    return {
      bg_list: ["../assets/bg.jpg", "../assets/bg.jpg", "../assets/bg.jpg"],
